...
AniIDTailsAni_Cower		= id(TailsAni_Cower_ptr)		; 33 ; $21
...
Clone_Driver_RAM		ds.b	$500	; $FFFFF100-$FFFFF5FF ; unused, leftover from the Sonic 1 sound driver (and used by it when you port it to Sonic 2)
